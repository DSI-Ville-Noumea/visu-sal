...
/**
 * Objet m�tier PaieEntete
 */
public class PaieEntete extends nc.mairie.technique.BasicMetier {
	public String nomatr;
	public String percou;
	public String licate;
	public String ligrad;
	public String forf;
	public String iban;
	public String ina;
	public String inm;
	public String limodr;
	public String libhor;
	public String nbcong;
	public String nom;
	public String prenom;
	public String nuretr;
	public String numutu;
	...
	public String libanq;
	public String indcor;
	public String vap;
	public String coef;
	public String ptcafat;
	public String smig;
	public String modreg;
	public String ipomp;
	public String solde1;
	public String solde2;
	public String nbrcp;
/**
 * Constructeur PaieEntete.
 */
public PaieEntete() {
	super();
}
...
protected nc.mairie.technique.BasicBroker definirMyBroker() { 
	return new PaieEnteteBroker(this); 
}
/**
 Methode � d�finir dans chaque objet M�tier pour instancier un Broker 
*/
...
/**
 * Retourne un ArrayList d'objet m�tier : PaieEntete.
 * @return java.util.ArrayList
 */
public static java.util.ArrayList listerPaieEntete(nc.mairie.technique.Transaction aTransaction) throws Exception{
...
public static PaieEntete chercherPaieEntete(nc.mairie.technique.Transaction aTransaction, String nomatr, String moiscourant) throws Exception{
	PaieEntete unPaieEntete = new PaieEntete();
	return unPaieEntete.getMyPaieEnteteBroker().chercherPaieEntete(aTransaction, nomatr, moiscourant);
}
/**
...
public boolean creerPaieEntete(nc.mairie.technique.Transaction aTransaction )  throws Exception {
	...
	return getMyPaieEnteteBroker().creerPaieEntete(aTransaction);
}
/**
...
public boolean modifierPaieEntete(nc.mairie.technique.Transaction aTransaction) throws Exception {
	...
	return getMyPaieEnteteBroker().modifierPaieEntete(aTransaction);
}
/**
...
public boolean supprimerPaieEntete(nc.mairie.technique.Transaction aTransaction) throws Exception{
	...
	return getMyPaieEnteteBroker().supprimerPaieEntete(aTransaction);
}
}
